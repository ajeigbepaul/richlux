...
function RequestModal({ visible, setRequestModal, requestModal, listingId }) {
  ...
  return (
    <div className="md:w-3/5 w-full h-[85%] bg-white shadow-2xl absolute top-24 md:top-20 z-40 rounded-md p-2 left-1/2 -translate-x-1/2">
      <div className="md:flex md:space-x-2 w-full h-full">
        <div className="flex flex-col bg-ink-100 w-full h-full">
          ...
          >
            <Input
              ...
              className="p-2 rounded-md border border-ink-300 text-ink-700 placeholder:text-ink-500 text-sm focus:outline-none focus:ring-2 focus:ring-brand-400"
            />
            <Input
              type="email"
              value={email}
            ...
            <SelectInput
              ...
              className="p-2 rounded-md border border-ink-300 text-ink-700 text-sm focus:outline-none focus:ring-2 focus:ring-brand-400"
            />
            <SelectInput
              value={bed}
        ...
        <div className="w-full bg-brand-50">
          <div className="flex justify-between items-center w-full p-2">
            <h2 className="text-ink-900 font-bold">Text Us Your Taste.</h2>
            <div
          ...
          <div className="p-4 w-full">
            <textarea
              ...
              className="p-2 md:w-96 md:h-44 w-full rounded-md border border-ink-300 focus:outline-none focus:ring-2 focus:ring-brand-400"
