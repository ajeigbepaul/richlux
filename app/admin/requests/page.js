...
export default function AdminRequestsPage() {
  ...
  // Direct, single-listing inquiries live on their own page now
  // (/admin/enquiries) -- excluded here so this list stays focused on the
  // multi-offer marketplace.
  const { data, isLoading, mutate } = useSWR("/api/userrequest?hasListing=false", fetcher);
  ...
  return (
    <div className="space-y-6">
      <Breadcrumb items={[{ label: "Dashboard", href: "/admin" }, { label: "Requests" }]} />
